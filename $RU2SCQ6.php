...
<head>
	...
	<link rel="stylesheet" href="<?php bloginfo('template_url')?>/spec/style.css?version=23">
...
<div class="container-fluid bottomness allWidth">
	<div class="swiper-container allWidth__sw">
		<div class="swiper-wrapper">
			<?php
				$args1 = new WP_Query( 'post_type=project&cat=1827&posts_per_page=5&tag__in=2851');
				$args2 = new WP_Query( 'post_type=project&cat=1415,1828,1831,1830&posts_per_page=5&tag__not_in=2851');
				
				$querySlider = array_merge($args1 -> posts, $args2 -> posts);
